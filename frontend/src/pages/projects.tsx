      ...
      <div className="mx-auto max-w-6xl px-6 pt-28 pb-24">
        ...
        >
          ...
          <p className="mt-4 max-w-xl text-muted-foreground">
            Every project I've built — from AI platforms to full commerce stacks.
          </p>
        </motion.div>
            ...
            return (
              ...
              >
                <div className="relative aspect-[16/10] overflow-hidden">
                  ...
                  />
                  <div className="pointer-events-none absolute inset-0 flex items-center justify-center bg-background/50 opacity-0 backdrop-blur-md transition-all duration-500 group-hover:pointer-events-auto group-hover:opacity-100">
